/*eslint-disable*/ module.exports = {
  messages: {
    ...
    Balance: "Solde",
    Option: "Obligations",
    "Option Price": "Prix de l'obligation",
    "Option discounts": "Rabais sur les obligations",
    "Option {0}": ["Option ", ["0"]],
    ...
    "Connect your wallet to stake OHM": "Connectez votre portefeuille pour déposer des OHM",
    ...
    "First time optioning": "First time optioning",
    ...
    'Note: The "Approve" transaction is only needed when optioning for the first time; subsequent optioning only requires you to perform the "Option" transaction.':
    ...
    "You have an existing option. optioning will reset your vesting period and forfeit rewards. We recommend claiming rewards first or using a fresh wallet. Do you still want to proceed?":
